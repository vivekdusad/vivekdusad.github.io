...
of network bandwidth and leads to great user expirence.

For Achieving this we are going to use basic concept of Http protocol **Etag**.
...
We can use Etag for caching purpose
